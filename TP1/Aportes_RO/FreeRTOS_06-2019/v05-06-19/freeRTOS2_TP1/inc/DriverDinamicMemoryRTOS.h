...
//
//	typedef void (*MemoryFreeFCN)(QMPool *const ,void *,uint8_t ,void *,uint8_t );
//
//	typedef void* (*MemoryAllocFCN)(QMPool *const ,uint_fast16_t const ,uint8_t ,uint64_t ,uint8_t  );
